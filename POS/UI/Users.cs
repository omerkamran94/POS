...
namespace POS.UI
{
    public partial class Users : Form
    {
        ...
        if(Validation())
        {
            ...
            {
                    //Showing MessageBox
                    DialogResult = MessageBox.Show("User already exist do you want to update", "Message", MessageBoxButtons.YesNo);
                    if (DialogResult == DialogResult.Yes)
                    {
                        u.usersid = Convert.ToInt32(txtid.Text);
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            int ri = e.RowIndex;
            txtid.Text = dgvusers.Rows[ri].Cells["usersid"].Value.ToString();
            txtusername.Text = dgvusers.Rows[ri].Cells["user_name"].Value.ToString();
            txtusertype.Text = dgvusers.Rows[ri].Cells["user_type"].Value.ToString();
            txtpassword.Text = dgvusers.Rows[ri].Cells["password"].Value.ToString();
            txtemail.Text = dgvusers.Rows[ri].Cells["email"].Value.ToString();
            txtcnic.Text = dgvusers.Rows[ri].Cells["cnic"].Value.ToString();
            txtaddress.Text = dgvusers.Rows[ri].Cells["adress"].Value.ToString();
            txtphoneno.Text = dgvusers.Rows[ri].Cells["phone_no"].Value.ToString();
            chk_active.Checked = Convert.ToBoolean(dgvusers.Rows[ri].Cells["active"].Value.ToString());
        }
