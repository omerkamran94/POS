    ...
    public partial class Suppliers : Form
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            ...
            if (Validation())
            {
                ...
                {
                    //Showing MessageBox
                    DialogResult = MessageBox.Show("Supplier already exist do you want to update", "Message", MessageBoxButtons.YesNo);
                    if (DialogResult == DialogResult.Yes)
                    {
                        u.suppliersid = Convert.ToInt32(txtid.Text);
        ...
        private void dgvsuppliers_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            int ri = e.RowIndex;
            txtid.Text = dgvsuppliers.Rows[ri].Cells["suppliersid"].Value.ToString();
            txtusername.Text = dgvsuppliers.Rows[ri].Cells["user_name"].Value.ToString();
            txtemail.Text = dgvsuppliers.Rows[ri].Cells["email"].Value.ToString();
            txtcompany.Text = dgvsuppliers.Rows[ri].Cells["company"].Value.ToString();
            txtadress.Text = dgvsuppliers.Rows[ri].Cells["adress"].Value.ToString();
            txtphoneno.Text = dgvsuppliers.Rows[ri].Cells["phone_no"].Value.ToString();
            chk_active.Checked= Convert.ToBoolean(dgvsuppliers.Rows[ri].Cells["active"].Value.ToString());
        }
